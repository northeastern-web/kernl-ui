...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-load]').on('click touch', function (e) {
  e.preventDefault();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.loader').removeClass('d-none').delay(5000).queue(function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass('d-none').dequeue();
...
if (document && document.querySelectorAll('.gumshoe a').length > 0) {
  var gum = new gumshoejs__WEBPACK_IMPORTED_MODULE_0___default.a();
  gum('.gumshoe a', {
    navClass: '-active',
    contentClass: '-active',
    offset: '50'
...
$shuffle.on('activate.swap deactivate.swap', function () {
  var dis = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this),
      disNext = dis.next(),
