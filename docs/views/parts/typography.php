  ...
  <div class="row">
    <div class="col w--2/3@t ow--1/6@t">
      <section class="section pa--2 mb--2@d bg--white tc--gray-800">
        ...
        <h3>Representation by Counsel<sup>[4]</sup></h3>
        <ol>
