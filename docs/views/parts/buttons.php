<section class="section ta--c">
  ...
  <div class="row">
    ...
    <div class="col --12@xs --6@md --3@xl p--b-1@xs">
      ...
      <p><a class="btn --transparent +pill" data-component="button" href="#">Pill Transparent</a></p>
...
<section class="section ta--c k_bg-dark">
  ...
  <div class="row">
    ...
    <div class="col --12@xs --6@md --3@xl p--b-1@xs">
      ...
      <p><a class="btn --transparent --light +pill" data-component="button" href="#">Pill Transparent Light</a></p>
    ...
    <div class="col --12@xs --6@md --3@xl p--b-1@xs">
      ...
      <p><a class="btn --white +pill +outline" data-component="button" href="#">Pill White Outline</a></p>
      <p><a class="btn --white --lg +outline" data-component="button" href="#">White Outline lg</a></p>
      <p><a class="btn --white --lg +block +outline" data-component="button" href="#">Block White Outline lg</a></p>
    </div>
  </div>
</section>
<section class="section k_bg-light">
  ...
  <div class="row">
    <div class="col --12@xs --6@md p--b-1@xs">
      ...
      <p class="btn__group">
        <button class="btn --sm --dark" data-component="button">This One</button>
    ...
    <div class="col --12@xs --6@md p--b-1@xs">
      ...
      <p>
        <a class="btn --xs" data-component="button" href="#">Go Forth
          <span class="btn__icon +right"><i data-feather="fast-forward"></i></span>
        </a>
      </p>
      <p>
        <a class="btn --sm" data-component="button" href="#">
          <span class="btn__icon +left"><i data-feather="settings"></i></span>
          Make Buttons
        </a>
      </p>
      <p>
        <a class="btn" data-component="button" href="#">
          <span class="btn__icon +left"><i data-feather="headphones"></i></span>
          Hear Me Now
        </a>
      </p>
      <p>
