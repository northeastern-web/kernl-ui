...
<section class="section">
  <div class="row">
    <div class="col mx-auto pb-1">
      ...
      <div class="accordion">
        <a id="toggle_0_2" href="#" data-swap-target="#accordion_0_2" class="accordion_link" data-toggle data-swap-options='{"collapse":true}' role="tab" data-swap-group="accordiongroup_0">Dolor Fermentum</a>
