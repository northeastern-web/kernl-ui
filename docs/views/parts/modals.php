  ...
  <div class="row">
    <div class="col w-1/3@t">
      ...
      <p class="modal-demo ta-c">
        <a class="btn -sm" href="#" data-size="sm" data-toggle="modal" data-target="#modal_base">Modal sm</a>
        ...
        <a class="btn" href="#" data-size="xl" data-toggle="modal" data-target="#modal_base">Modal xl</a>
      </p>
      ...
      <div class="modal"
           ...
           aria-hidden="true">
        <div class="modal_screen" data-dismiss="modal"></div>
    ...
    <div class="col w-1/3@t">
      ...
      <p class="modal-demo ta-c">
        <a class="btn -sm bg-black-alpha" href="#" data-size="sm" data-toggle="modal" data-target="#modal_dark">Modal sm</a>
        <a class="btn -sm bg-black-alpha" href="#" data-size="base" data-toggle="modal" data-target="#modal_dark">Modal</a><br>
        <a class="btn bg-black-alpha" href="#" data-size="lg" data-toggle="modal" data-target="#modal_dark">Modal lg</a>
        <a class="btn bg-black-alpha" href="#" data-size="xl" data-toggle="modal" data-target="#modal_dark">Modal xl</a>
      </p>
    ...
    <div class="col w-1/3@t">
      ...
      <p class="modal-demo ta-c">
        <a class="btn -sm bg-gray-200" href="#" data-size="sm" data-toggle="modal" data-target="#modal_grid">Grid sm</a>
        ...
        <a class="btn bg-gray-200" href="#" data-size="xl" data-toggle="modal" data-target="#modal_grid">Grid xl</a>
      </p>
      <div class="modal"
           id="modal_grid"
           tabindex="-1"
           ...
           aria-hidden="true">
        <div class="modal_screen" data-dismiss="modal"></div>
        <div class="modal_body bg-white pa-0 section -nogutters">
          ...
          <div class="row">
            <div class="col mx-auto w-2/3@t">
              ...
              <div class="pa-1">
                <h2>David Mary Davenport</h2>
                <p>Curabitur Blandit Tempus Porttitor<br>
  ...
  <div class="row">
    <div class="col">
      <div class="modal-demo ta-c py-1 py-3@t">
        <a href="#" data-toggle="modal" data-size="full" data-target="#modal_search" class="tc-black">
